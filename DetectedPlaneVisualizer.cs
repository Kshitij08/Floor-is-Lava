...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneVisualizer : MonoBehaviour
    {
        ...
        public void ChangeTextureWood()
        {
            m_MeshRenderer = GetComponent<MeshRenderer>();
            m_MeshRenderer.sharedMaterial.SetTexture("_MainTex", woodTexture);
        ...
        //Kshitij
        //To change the texture
        public void ChangeTextureGrass()
        {
            m_MeshRenderer = GetComponent<MeshRenderer>();
            m_MeshRenderer.sharedMaterial.SetTexture("_MainTex", grassTexture);
        ...
        //Kshitij
        //To change the texture
        public void ChangeTextureLava()
        {
            m_MeshRenderer = GetComponent<MeshRenderer>();
            m_MeshRenderer.sharedMaterial.SetTexture("_MainTex", lavaTexture);
        ...
        {
            m_MeshRenderer = GetComponent<MeshRenderer>();
            m_MeshRenderer.sharedMaterial.SetTexture("_MainTex", defaultTexture);
